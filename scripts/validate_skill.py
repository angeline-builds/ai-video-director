...
SKILL_NAME = "ai-video-director"
SKILL_DIR = ROOT / "skills" / SKILL_NAME
SKILL_MD = SKILL_DIR / "SKILL.md"
OPENAI_YAML = SKILL_DIR / "agents" / "openai.yaml"
REFERENCE_PATHS = {
    SKILL_DIR / "references" / "prompt-templates.md",
    SKILL_DIR / "references" / "quality-safety-checklist.md",
}
...
def main() -> None:
    ...
    print("AI Video Director structure and sensitive-content checks passed.")
